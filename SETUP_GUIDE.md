# Cresca Basket DeFi - Movement Network Hackathon

## Quick Setup Instructions

Since automated directory creation is limited, please run these commands manually:
...
Then create the files as specified below.

## Phase 1: Smart Contract Foundation (CURRENT)

### File: sources/basket_vault.move
...
### File: sources/price_oracle.move
...
2. Copy the Move modules into the sources/ directory
3. Run `movement move compile` to verify
4. Proceed to deployment and backend integration

## Git Commit Schedule

After each milestone:
- "Initialize Move project structure"
- "Add basket vault module"
- "Implement price oracle module"
- "Complete leverage engine module"
