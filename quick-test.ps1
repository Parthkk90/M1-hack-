...
# Tests all contracts using REST API
...
try {
    ...
    Write-Host "[FAIL] Could not fetch modules: $_`n" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "[FAIL] Could not fetch balance: $_`n" -ForegroundColor Red
}
...
try {
    ...
    Write-Host "[PENDING] Basket vault not initialized yet`n" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "[PENDING] Price oracle not initialized yet`n" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "[PENDING] Funding rate not initialized yet`n" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "[PENDING] Rebalancing engine not initialized yet`n" -ForegroundColor Yellow
}
...
try {
    ...
    Write-Host "[PENDING] Revenue distributor not initialized yet`n" -ForegroundColor Yellow
}
...
Write-Host "`nTo initialize contracts, run:" -ForegroundColor Yellow
Write-Host "  node test-contracts.js" -ForegroundColor White
Write-Host "  (or use aptos CLI commands manually)`n" -ForegroundColor White

Write-Host "Contract Features:" -ForegroundColor Yellow
